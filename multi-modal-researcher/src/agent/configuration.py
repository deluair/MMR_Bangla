...
class Configuration:
    ...
    synthesis_temperature: float = 0.5        # Factual and precise
    podcast_script_temperature: float = 0.4   # Creative dialogue
    
    # TTS Configuration - NOTE: Gemini 1.5 Flash TTS has a specific voice list.
    # None are explicitly Bengali, so we use a placeholder.
    mike_voice: str = "puck" 
